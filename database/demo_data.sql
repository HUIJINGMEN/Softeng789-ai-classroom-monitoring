...
VALUES
    ('d0300000-0000-4000-8000-000000000001', 'Lab 3', 'Engineering Computer Lab 3', 36),
    ('d0300000-0000-4000-8000-000000000002', '303-G14', 'Science Centre 303-G14', 48),
    ('d0300000-0000-4000-8000-000000000003', 'Case Room 2', 'Business School Case Room 2', 32)
...
VALUES
    ...
    ('d4000000-0000-4000-8000-000000000004', '8094044b-13c8-44f4-8b55-85575ad4558a', 'd2000000-0000-4000-8000-000000000001', 'Extended off-desk hand movement', 0.710, TIMESTAMPTZ '2026-09-04 10:27:05+12', 'REJECTED', 'Movement was related to retrieving course material.'),
    ('d4000000-0000-4000-8000-000000000005', 'aa9b81fd-cdec-48be-952f-738ae5a04a81', 'd2000000-0000-4000-8000-000000000001', 'Leaving the seat area', 0.680, TIMESTAMPTZ '2026-09-04 10:31:02+12', 'CORRECTED', 'Corrected after reviewing the tracked seat region.'),
    ...
    ('d4000000-0000-4000-8000-000000000011', '9dc06bc5-1a33-41fa-82c7-e7aff4ca6fd1', 'd2000000-0000-4000-8000-000000000012', 'Prolonged head-down posture', 0.740, TIMESTAMPTZ '2026-09-03 10:21:14+12', 'PENDING_REVIEW', NULL),
...
FROM (VALUES
    ...
    ('d5000000-0000-4000-8000-000000000011'::uuid, '9dc06bc5-1a33-41fa-82c7-e7aff4ca6fd1'::uuid, 'd2000000-0000-4000-8000-000000000012'::uuid, 'Prolonged inactivity', 0.780::numeric, TIMESTAMPTZ '2026-09-03 10:43:18+12', 'AWAITING_REVIEW', NULL::timestamptz, NULL::text, NULL::text)
